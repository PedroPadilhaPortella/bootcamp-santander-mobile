...
class NotesAdapter(
    ...
    override fun onBindViewHolder(holder: NotesViewHolder, position: Int) {
        ...
        holder.noteTitle.text = mCursor?.getString(mCursor?.getColumnIndex(TITLE_FIELD) as Int)
        holder.noteDescription.text = mCursor?.getString(mCursor?.getColumnIndex(DESCRIPTION_FIELD) as Int)
